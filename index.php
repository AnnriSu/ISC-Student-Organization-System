        ...
        <div class="container-fluid d-flex align-items-center flex-wrap ">
            <div class="d-flex gap-4 mx-auto mx-sm-0 me-xs-auto align-content-lg-center">
                <a class="navbar-brand d-flex ms-2 ms-lg-4 justify-content-center" href="index.php">
                    <img src="assets\img\isc_brand_bold.png" alt="Logo" height="auto" class="mt-1 mb-1" style="max-width: 250px; width: auto;">
                </a>
            </div>
        ...
        <div class="row g-5 px-4 justify-content-center">
            <div class="col-12 col-sm-12 col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm rounded-4">
                    <img src="assets\img\1.jpg" class="card-img-top" alt="Photo 1" style="object-fit:cover; height:300px;">
            ...
            <div class="col-12 col-sm-12  col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm rounded-4">
                    <img src="assets\img\2.png" class="card-img-top" alt="Photo 2" style="object-fit:cover; height:300px;">
                    <div class="card-body d-flex flex-column text-center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-4">
                <div class="card h-100 shadow-sm rounded-4">
                    <img src="assets\img\3.png" class="card-img-top " alt="Photo 3" style="object-fit:cover; height:300px;">
                    <div class="card-body d-flex flex-column text-center">
    ...
    <div class="container-fluid introduction-container p-0 shadow-sm pb-3 ">
        <div class="row g-0">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 d-flex align-items-center justify-content-center">
                ...
                <img src="assets\img\mascot full 2.png" alt="Mascot" class="img-fluid d-lg-none" style="object-fit:contain; max-height: 400px;">
            </div>
                    ...
                    <div class="text-lg-end text-center">
                        <button class="btn btn-lg rounded rounded-5 px-4 px-lg-5 pb-2 pt-2" style="background-color: #84152c; color: white;">
                            <a class="nav-link text-light" href="sponsorship.php">
                                <h4 class="fw-bold my-2  text-center d-flex justify-content-center">Become a Sponsor</h4>
                            </a>
                        </button>
                    </div>
                </div>
